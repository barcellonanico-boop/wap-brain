...
|---|---|---|---|
| sops/SOP_01_Update_Existing_Post.md | Rewrite an existing wearepalermo.com blog post that's losing traffic. 11 steps across 3 phases (Setup / Write / Verify+Publish). 3-pass writing model: Pass 1 information, Pass 2 voice, Pass 3 HTML. | When a post is rotting per WAP_13 (lost clicks YoY), or has structural issues, or needs full freshness pass. NOT for minor edits. | v2.0 — Active |
