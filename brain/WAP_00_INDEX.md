...
| WAP_10_PLACES_EXPERIENCES.md | Places, experiences, monuments, rituals, and avoid list. Master Index of E001-E041 (Tier 1 affiliate experiences, Tier 2 monuments, Tier 3 cultural rituals). Avoid Index of A001-A003 (Tier 0 things to NOT recommend). Tag taxonomy includes Location, Experience type, Theme, Duration, Difficulty, Audience, Season, Time of Day, Vibe, Cost, Avoid Reason, Monetization. Used by Copywriting agent in SOP_01 Step 3 and SOP_02 Step 3 as raw material for places to mention. | When adding new affiliate experiences, monuments, rituals, or avoid items. When tag taxonomy needs new categories or values. |
