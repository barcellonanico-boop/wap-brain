...
| WAP_05_VOICE_AND_PERSONA.md | Nico's persona in full. Two voice modes (Mode A bar comedian, Mode B wise Sicilian). 21 signature moves. DOs and DON'Ts. Fireable offenses. Banned-in-body-copy words list (18 industry-insider terms forbidden in reader-facing copy: "SEO", "AI Overview", "ranking", "keywords", etc.). Palermo Local Truth Locks: Centro Storico unified as 1 area not 4 sub-neighborhoods, Vucciria fact lock (restaurant/nightlife NOT morning fish market), Capo/Ballarò as working markets. | Before any writing task. Non-negotiable. | When new examples of good/bad output are identified during test runs, when new banned words or local truth locks are discovered. |
