...
| WAP_05c_VOICE_DNA.md | 11 voice traits with examples (Anti-Romantic Pragmatist, Exaggerated Biological Threat, Dialogic Strawman, Reluctant Educator, Scam Radar Disclosure, Staccato Absolutes, Class/Culture Knife, Setup-Pause-Snap, Italian Roast, Hyperbolic Origin Story, Pop Culture Hook). Structural rhythm metrics, lexical profile (approved Italian/Sicilian list + banned generic phrases), 6 transformation examples (fact → voice), engineered checklist (8 sectional + 7 global), 6 failure modes, Voice Pass Phase 6 procedure with hard stop at 2 cycles. Family cast: Nonna Nunzia, father, grandfather, bisnonno Michele, Willy. | Reference during Voice Pass (Phase 6) of v2.3 workflow. Agent applies checklist and flags failing H2 sections to Nico. | When new article patterns emerge OR when traffic/voice feedback shifts OR every 6 months audit. |
