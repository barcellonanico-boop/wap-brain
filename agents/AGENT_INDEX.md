...
| WAP Copywriting | [COPYWRITING_SYSTEM_PROMPT.md](COPYWRITING_SYSTEM_PROMPT.md) | All writing: blog posts, rewrites, email sequences, opt-in pages, ad copy, microcopy. Voice lock to Nico's Italian-American comedian style. | SOP_01 Step 3, Step 6. SOP_02 Step 3. All content tasks. | project_knowledge_search | v1.0 active |
