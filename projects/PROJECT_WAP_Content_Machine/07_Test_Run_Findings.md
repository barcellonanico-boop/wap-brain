...
### May 1 where-to-stay-palermo run — Findings #56-57
...
These three patches are the same lesson, applied at three layers (per-step, per-agent boundaries, per-claim hygiene). Apply as one commit post-publish.
