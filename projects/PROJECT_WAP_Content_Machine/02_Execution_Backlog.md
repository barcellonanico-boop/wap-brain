...
- [ ] 1.10 Write WAP_06_CONTENT_FORMAT.md — synthesize SEO/AIO rules from 05_SEO_AIO_Research.md with existing WAP format rules (no wall text, no dashes, text boxes) + WordPress publishing checklist [PM] [Est: 30 min | Actual: __ ]
...
- [ ] 2.0 Google Search Console audit: export performance data for all 77 posts, assign LOSING / RANKING / OUTDATED / EVERGREEN status, update WAP_04_CONTENT_INVENTORY.md [Architect] [Est: 60 min | Actual: __ ]
