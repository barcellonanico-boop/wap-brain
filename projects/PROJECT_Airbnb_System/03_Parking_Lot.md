...
| Apr 22, 2026 | Dynamic pricing tools (PriceLabs, Wheelhouse, Beyond) | 20-40 EUR/month. Nico currently prices manually. Possibly worth it after Phase 1-4 stabilizes. |
...
| Date | Idea | Notes |
|---|---|---|
| Apr 22, 2026 | Repurpose self-guided itineraries as WAP blog content or sellable product | 4 itineraries + best tours doc already exist. Could become 4 WAP blog posts or a Sicilian Way companion product. Belongs in a future WAP content project, not this one. |
| Apr 22, 2026 | Digital guidebook hosted on web with QR code in apartment | Replaces printed guidebook. Easier to update, impossible for guests to lose, trackable analytics. Needs a simple landing page per apartment. |
...
These come up in Phase 1 task execution. Answered during Task 1.1 (guidebook) and 1.2 (messages) kickoff, not now.
